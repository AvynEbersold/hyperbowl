        ...
        $.ajax({
          ...
          success: function(data) {
            for(let i = data.length - 1; i >= 0; i--){
              ...
              postHTML += ' | <span class="bordered-txt"><i class="far fa-thumbs-up"></i> ' + data[i].numberOfLikes + '</span> <span class="bordered-txt"><i class="far fa-eye"></i> ' + data[i].numberOfViews + '</span></p>';
